function aiturn()
{
    ...
    utility_human_bis = evaluate_fourth
        ...
        utility_function = 0.2*evaluate_first + 0.4*evaluate_second + 0.1*evaluate_third + 0.2*evaluate_fourth //-utility_first + utility_second - utility_third + utility_fourth
